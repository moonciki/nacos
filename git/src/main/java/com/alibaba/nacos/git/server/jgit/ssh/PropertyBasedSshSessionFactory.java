...
import com.alibaba.nacos.git.server.jgit.env.ProxyHostProperties;
...
public class PropertyBasedSshSessionFactory extends SshdSessionFactory {
    ...
    public PropertyBasedSshSessionFactory(JgitConfigProperty jgitEnvironmentProperties, JSch jSch) {
