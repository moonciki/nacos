...
create table tenant_git (
    ...
    path varchar(255),
    branch varchar(50),
    gmt_create timestamp default '2010-05-05 00:00:00' not null,
    gmt_modified timestamp default '2010-05-05 00:00:00' not null,
    sync_time timestamp,
    commit_id varchar(60),
    advance_configure varchar(10000),
    constraint tenant_git_pk primary key (id),
    constraint tenant_git_tenant_id_uindex unique (tenant_id)
);
